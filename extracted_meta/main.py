...
class ProducerLiteRuntime:
    ...
    def tensor_action(self, obs_tensors: dict):
        ...
        observed_player_count = largest_initial_player_count(obs_tensors)
        if mem.cached_player_count is None or observed_player_count > mem.cached_player_count:
            mem.cached_player_count = observed_player_count
